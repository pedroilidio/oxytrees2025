"""
Source:
    https://github.com/BrunoBelucci/mlflow_util/blob/main/migrate_mlflow_backend.py
"""
import mlflow
...
def migrate_mlflow_backend(from_tracking_uri, to_tracking_uri, max_results=50_000):
    ...
    for from_experiment in pbar_experiment:
        ...
        from_runs = from_client.search_runs(from_experiment.experiment_id, max_results=max_results)
        to_runs = to_client.search_runs(to_experiment_id, max_results=max_results)
        pbar = tqdm(from_runs)
