...
\begin{figure}[tbh]
    ...
    \begin{picture}(1,0.60000009)%
        ...
        \put(0,0){\includegraphics[width=\unitlength,page=1]{oxytrees_figures_train_test_v2.pdf}}%
...
\begin{figure}
    \includegraphics[width=0.49\linewidth]{ablation_Inductive_AUPRC_00.pdf}
    \hfill
    \includegraphics[width=0.49\linewidth]{ablation_Inductive_AUPRC_50.pdf}
    \caption{
...
\begin{figure}[tbh]
    ...
    \includegraphics[width=0.49\linewidth]{empirical_complexity_fit.pdf}
    \includegraphics[width=0.49\linewidth]{empirical_complexity_leaf_assign.pdf}
...
\begin{figure}[tbh]
    \centering
    \includegraphics[width=\linewidth]{leaf_size_Inductive_AUPRC_00.pdf}
    \includegraphics[width=\linewidth]{leaf_size_Inductive_AUROC_00.pdf}
    \caption{
...
\begin{figure}[ht!]
    \includegraphics[width=.48\linewidth]{number_of_trees_Inductive_AUROC_0_BICTR_Oxytrees.pdf}
    \hfill
    \includegraphics[width=.495\linewidth]{number_of_trees_Inductive_AUPRC_0_BICTR_Oxytrees.pdf}
