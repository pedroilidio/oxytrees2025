...
\title{Cover Letter}
\author{Pedro Ilídio, Felipe Kenji Nakano, Alireza Gharahighehi, \\ Ricardo Cerri, Robbe D'hondt and Celine Vens}
\date{December 2024}
\begin{document}
%
\maketitle
...
With this letter, we are submitting our manuscript entitled ``Oxytrees: model trees for biparatite learning" by Pedro Ilídio, Felipe Kenji Nakano, Alireza Gharahighehi, Ricardo Cerri, Robbe D'Hondt and Celine Vens, which proposes a novel state-of-th-e-art tree ensemble model for bipartite learning. 
...
Pedro Ilídio, Felipe Kenji Nakano, Alireza Gharahighehi, Ricardo Cerri, Robbe D'hondt and Celine Vens
