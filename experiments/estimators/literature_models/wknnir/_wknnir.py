...
from .inbase import InductiveModelBase


class WkNNIR(InductiveModelBase, BaseBipartiteEstimator, RegressorMixin):
    """
    ...
    def fit(self, X, y, cvs=4):
        drugMat, targetMat, intMat = *X, y
